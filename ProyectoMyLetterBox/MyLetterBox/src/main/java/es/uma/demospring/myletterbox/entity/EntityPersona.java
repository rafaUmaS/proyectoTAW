...
public class EntityPersona implements Serializable {
    ...
    public EntityPersona(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EntityPersona)) {
            return false;
        }
        EntityPersona other = (EntityPersona) object;
    ...
    public String toString() {
        return "es.uma.demospring.myletterbox.entity.Persona[ id=" + id + " ]";
    }
