...
public class CountryController extends BaseController {
    ...
    @GetMapping("/nuevo")
    public String crearCountry(Model model) {
        model.addAttribute("countries", this.countriesService.listarCountries());
    ...
    @GetMapping("/editar")
    public String editarCountry(@RequestParam("id") String id, Model model) {
        model.addAttribute("countries", this.countriesService.listarCountries());
    ...
    @GetMapping("/eliminar")
    public String eliminarCountry(@RequestParam("id") String id) {
